...
<html lang="en">
  <head>
    ...
    <meta
      ...
      content="HodCjWqvqbQe_TbYff1tceDDxLb0hUbPEJw-C4CAYDk"
    />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta
      name="google-site-verification"
      content="csJ4s4L5PiOK17bjTmx7Pj63hQ6R8B7tor7c2KkEu9s"
    />
    <meta
      name="keywords"
      content="Jak obniżyć podatek od środków transportowych, Podatek drogowy, Minimalne stawki podatku transportowego"
    />
    <meta
      name="description"
    ...
    <link
      rel="shortcut icon"
      href="<?php echo bloginfo('template_url'); ?>/assets/images/favicon.ico"
      type="image/x-icon"
    />
    <?php 
  ...
  <div class="white-navbar">
    ...
    <a class="header-phone" href="tel:693 546 135">
      <svg
        width="41"
        height="41"
        viewBox="0 0 41 41"
    ...
    <img
      src="<?php echo bloginfo('template_url'); ?>/assets/images/unia-logo.svg"
      alt="Unia Europejska"
      class="unia-logo"
    />
    <header class="header">
